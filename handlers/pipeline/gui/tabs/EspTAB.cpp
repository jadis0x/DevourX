...
void EspTAB::Render()
{
	...
	ImGui::Spacing();
	GuiWidgets::SectionTitle("tabs.esp.visual_tracking", ImVec4(1.0f, 1.0f, 1.0f, 1.0f));

	if (ImGui::BeginTable("##esp_layout", 2, ImGuiTableFlags_SizingStretchSame | ImGuiTableFlags_NoBordersInBody))
	{
		ImGui::TableNextColumn();
		ImGui::BeginGroup();
		GuiWidgets::SectionTitle("tabs.esp.azazel.title", ImVec4(1.0f, 1.0f, 1.0f, 0.85f));
		...
		ImGui::TableNextColumn();
		ImGui::BeginGroup();
		GuiWidgets::SectionTitle("tabs.esp.players.title", ImVec4(1.0f, 1.0f, 1.0f, 0.85f));
		...
		ImGui::BeginGroup();
		GuiWidgets::SectionTitle("tabs.esp.items.title", ImVec4(1.0f, 1.0f, 1.0f, 0.85f));

...
// DO_APP_FUNC(0x00B3EDE0, int32_t, PlayerState_get_ConnectionId, (PlayerState * __this, MethodInfo * method));
// DO_APP_FUNC(0x00B3EE40, void, PlayerState_set_ConnectionId, (PlayerState* __this, int32_t value, MethodInfo* method));
int32_t dPlayerState_get_ConnectionId(app::PlayerState* __this, MethodInfo* method);

// DO_APP_FUNC(0x00B3D640, void, PlayerState__ctor, (PlayerState * __this, MethodInfo * method));
void dPlayerState__ctor(app::PlayerState* __this, MethodInfo* method);

// DO_APP_FUNC(0x00B3FAB0, String *, PlayerState_get_PlayerId, (PlayerState * __this, MethodInfo * method));

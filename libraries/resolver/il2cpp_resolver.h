...
// ============================================================
//  DevourX Mod Menu - IL2CPP Utility Header
//	Author: Jadis0x
//
//	This header provides a collection of helper classes,
//	utilities, and wrappers for working with Unity IL2CPP.
// 
//	Includes :
//
//	• SafePtr : Safe pointer checks and exception handling
//	• Vector3Utils : Basic math operations(Dot, Normalize, etc.)
//	• Il2CppInvoker : Helpers for loading images, classes, methods
//	• Il2cppData : Class / type lookup and caching
//	• UGameObject / UComponent / UCamera : Unity object wrappers
//	• UObject<T> : Template class for object management& caching
//	• Func namespace : Quick object finder helpers
//
//
//
//  NOTE: The code may seem complex at first glance,
//  but it mainly provides structured wrappers to make
//  IL2CPP interaction more organized and easier to work with.
// ================
